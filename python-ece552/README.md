...
failed autograder run. See [Verilog Rules](https://ece552.wiscarch.org/rules/) on the course site
...
your submission violates a rule in [Verilog Rules](https://ece552.wiscarch.org/rules/) -- read the
...
[Verilog Rules](https://ece552.wiscarch.org/rules/) first; if you still think it's wrong, post on
